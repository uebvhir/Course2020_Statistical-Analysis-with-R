...
A phosphoproteomics experiment has been performed as described in figure 1 (if not available look for image "phosphoproteomics.png" in the page or the repository).
...
This can be solved by creating new names with the `make.names` function.
...
# Obtaining and analyzing data from the web 
...
More information about the study can be found in GEO and in Gonzalo R. and Sanchez A."
