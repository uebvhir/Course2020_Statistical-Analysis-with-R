...
with(hta,t.test(tad1,mu=90, alternative="greater") ) # One sample T.test
```

- In wilcoxon test the null hypothesis is about the median

```{r onewilcoxtest , mysize=TRUE, size='\\small'}
with(hta,wilcox.test(tad1,mu=90, alternative="greater") ) # One sample wilcoxon
```
